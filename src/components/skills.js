            ...
            <Container>
                <Row>
                    ...
                    <div className="skill-bx">
                        <TrackVisibility>
                                {({isVisible}) =>
                                    <div className={isVisible ?"animate__animated animate__bounce":""}>
                                        ...
                                        My passion for technology has led me towards pursuing a career in software development where I can apply my analytical mindset, problem-solving abilities, and attention to detail
                                    </div>}
                            </TrackVisibility>
                        ...
                        <img src={colorSharp} alt="error" className="background-image-left" />
                    </div>
                    </Col>
                </Row>
            </Container>
